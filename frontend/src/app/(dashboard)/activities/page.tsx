...
export default function ActivitiesPage() {
  ...
  return (
    <div className="space-y-10 pb-10">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8 bg-white/80 dark:bg-card/80 backdrop-blur-xl p-8 rounded-lg border border-slate-200 dark:border-primary/10 shadow-2xl relative overflow-hidden group">
          ...
          <div className="flex items-center gap-5 flex-wrap">
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground/40">Audit System</span>
              </div>
            </div>
          </div>
        ...
        <div className="flex items-center gap-4 relative z-10">
          <Button 
            ...
            className="h-14 px-8 font-bold uppercase tracking-[0.2em] shadow-xl shadow-primary/20 rounded-lg text-[10px] gap-3 transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] bg-primary hover:bg-primary/90 border border-white/10 text-white" 
          >
            {isLoading ? (
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          <Card className="rounded-lg border border-slate-200 dark:border-primary/5 bg-white/80 dark:bg-card/80 backdrop-blur-xl shadow-lg hover:shadow-xl transition-all duration-200 group overflow-hidden relative">
            ...
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 relative z-10">
              <CardTitle className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground/60">Total Activités</CardTitle>
              <div className="p-2.5 bg-primary/10 rounded-lg border border-primary/20 group-hover:scale-110 transition-transform duration-200">
                <Activity className="h-4 w-4 text-primary" />
              </div>
            </CardHeader>
            <CardContent className="relative z-10">
              <div className="text-4xl font-black tracking-tighter text-slate-900 dark:text-white">{summary.totalActivities}</div>
              <p className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground/40 mt-1">7 derniers jours</p>
            </CardContent>
          </Card>
          ...
          <Card className="rounded-lg border border-slate-200 dark:border-primary/5 bg-white/80 dark:bg-card/80 backdrop-blur-xl shadow-lg hover:shadow-xl transition-all duration-200 group overflow-hidden relative">
            ...
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 relative z-10">
              <CardTitle className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground/60">Utilisateurs Actifs</CardTitle>
              <div className="p-2.5 bg-emerald-500/10 rounded-lg border border-emerald-500/20 group-hover:scale-110 transition-transform duration-200">
                <Users className="h-4 w-4 text-emerald-500" />
              </div>
            </CardHeader>
            <CardContent className="relative z-10">
              <div className="text-4xl font-black tracking-tighter text-slate-900 dark:text-white">{summary.activeUsers}</div>
              <p className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground/40 mt-1">Utilisateurs uniques</p>
            </CardContent>
          </Card>
          ...
          <Card className="rounded-lg border border-slate-200 dark:border-primary/5 bg-white/80 dark:bg-card/80 backdrop-blur-xl shadow-lg hover:shadow-xl transition-all duration-200 group overflow-hidden relative">
            ...
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 relative z-10">
              <CardTitle className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground/60">Sessions Créées</CardTitle>
              <div className="p-2.5 bg-amber-500/10 rounded-lg border border-amber-500/20 group-hover:scale-110 transition-transform duration-200">
                <PlusCircle className="h-4 w-4 text-amber-500" />
              </div>
            </CardHeader>
            <CardContent className="relative z-10">
              <div className="text-4xl font-black tracking-tighter text-slate-900 dark:text-white">{summary.sessionsCreated}</div>
              <p className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground/40 mt-1">Total sessions initiées</p>
            </CardContent>
          </Card>
          ...
          <Card className="rounded-lg border border-slate-200 dark:border-primary/5 bg-white/80 dark:bg-card/80 backdrop-blur-xl shadow-xl hover:shadow-2xl transition-all duration-200 group overflow-hidden relative">
            ...
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 relative z-10">
              <CardTitle className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground/60">Messages Envoyés</CardTitle>
              <div className="p-2.5 bg-blue-500/10 rounded-lg border border-blue-500/20 group-hover:scale-110 transition-transform duration-200">
                <Send className="h-4 w-4 text-blue-500" />
              </div>
            </CardHeader>
            <CardContent className="relative z-10">
              <div className="text-4xl font-black tracking-tighter text-slate-900 dark:text-white">{summary.messagesSent}</div>
              <p className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground/40 mt-1">Envoyés avec succès</p>
            </CardContent>
          </Card>
        </div>
      )}
      ...
      <Card className="rounded-lg border border-slate-200 dark:border-primary/5 shadow-2xl overflow-hidden bg-white/80 dark:bg-card/80 backdrop-blur-xl relative group/card">
        ...
        <CardHeader className="bg-white/50 dark:bg-primary/[0.02] border-b border-slate-100 dark:border-primary/5 p-8 sm:p-10 relative z-10">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
            <div className="flex items-center gap-5">
              <div className="p-3.5 bg-primary/10 rounded-lg border border-primary/20 shadow-sm group-hover/card:scale-110 transition-transform duration-200">
                <History className="w-6 h-6 text-primary" />
              </div>
              <div className="space-y-1">
                <CardTitle className="text-2xl font-black uppercase tracking-tight text-slate-900 dark:text-white">Journal d'activité</CardTitle>
                <CardDescription className="font-bold text-[10px] uppercase tracking-[0.2em] text-muted-foreground/40 leading-relaxed">
                  Audit complet des opérations système
                </CardDescription>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="h-2 w-2 rounded-full bg-emerald-500 animate-pulse" />
              <span className="text-[10px] font-black uppercase tracking-widest text-emerald-500/80">Live Tracking Active</span>
            </div>
          </div>
        </CardHeader>
        <CardContent className="p-0 relative z-10">
          {isLoading ? <TableSkeleton rows={10} cols={5} /> : (
            <div className="overflow-x-auto scrollbar-thin scrollbar-thumb-slate-200 dark:scrollbar-thumb-primary/10">
              <Table>
                <TableHeader className="bg-slate-50/30 dark:bg-primary/[0.01]">
                  ...
                  <TableHead className="min-w-[250px] font-black uppercase tracking-[0.2em] text-[10px] py-6 text-muted-foreground/60">Détails de l'Opération</TableHead>
                  <TableHead className="hidden md:table-cell font-black uppercase tracking-[0.2em] text-[10px] py-6 text-muted-foreground/60">Adresse IP</TableHead>
                  ...
                  <TableRow>
                    <TableCell colSpan={7} className="h-64 text-center">
                      <div className="flex flex-col items-center justify-center gap-6 opacity-20">
                        ...
                        <p className="font-black uppercase tracking-[0.3em] text-xs">Aucun enregistrement disponible</p>
                      </div>
                    </TableCell>
                  </TableRow>
                ) : (
